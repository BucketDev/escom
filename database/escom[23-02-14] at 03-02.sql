...
# Base de datos: escom
# Tiempo de Generación: 2014-02-23 09:02:19 +0000
# ************************************************************
...
VALUES
	...
	(8,NULL,6,'Solicitudes','Módulo de visualización de las solicitudes de documentos en la plataforma','track_changes_2','EscomApp.controller.tracking.Trackings','2014-02-03 16:03:57',1,1),
...
VALUES
	('5949de9cc1cb03dc3bf216c1e9557b4f','::1','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.117 Safari/537.36',1393145652,'a:6:{s:9:\"user_data\";s:0:\"\";s:4:\"user\";s:7:\"rodrigo\";s:9:\"usuario_k\";s:1:\"1\";s:10:\"controller\";s:5:\"admin\";s:6:\"origen\";s:3:\"app\";s:3:\"rol\";s:1:\"1\";}');
...
CREATE TABLE `tb_usuarios` (
  ...
  `periodo_ingreso` varchar(11) DEFAULT NULL COMMENT 'clave de ingreso al plantel',
