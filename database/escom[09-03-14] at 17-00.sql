...
# Base de datos: escom
# Tiempo de Generación: 2014-03-09 23:00:36 +0000
# ************************************************************
...
VALUES
	...
	(2,1,'Jefe de Departamento','admin',1);
...
VALUES
	...
	(13,1,'editar_admin_usuarios','Editar usuarios en el módulo de administración de usuarios',1),
	(14,1,'eliminar_admin_usuarios','Eliminar usuarios en el módulo de administración de usuarios',1),
	(15,1,'agregar_admin_usuarios','Agregar usuarios en el módulo de administración de usuarios',1);
...
VALUES
	('6f4152d46ba8f839936aa065c9dc38bf','::1','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.146 Safari/537.36',1394403634,'a:6:{s:9:\"user_data\";s:0:\"\";s:4:\"user\";s:7:\"rodrigo\";s:9:\"usuario_k\";s:1:\"1\";s:10:\"controller\";s:5:\"admin\";s:6:\"origen\";s:3:\"app\";s:3:\"rol\";s:1:\"1\";}');
...
VALUES
	...
	(1,13,'2014-03-02 01:00:21',1,1),
	(1,14,'2014-03-02 01:00:27',1,1),
	(1,15,'2014-03-02 01:02:32',1,1);
...
CREATE TABLE `tb_usuarios` (
  ...
  `turno` tinyint(1) DEFAULT NULL COMMENT 'valor que indica el turno inscrito, 0-matutino, 1-vespertino, por defecto NULL',
  `timestamp_creacion` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'timestamp de creación del registro',
  `usuario_creacion_k` int(11) unsigned DEFAULT NULL COMMENT 'identificador del usuario que agregó el registro',
  `activo` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'bandera booleana de activación',
...
VALUES
	(1,1,'rodrigo','15ebf1f2fe0adce6fd6527ddfad05482d05b3668','Rodrigo','Loyola','Jaramillo','uploads/users/Immunologist-Male-Light-256.png','LOJR870826HMCYRD00',0,26,'rodrigo.loyola@live.com',2006630166,1,1,'20061',8,NULL,'2014-01-23 18:28:40',NULL,1),
	(13,2,'asdasd','','asdas',NULL,NULL,'uploads/users/Customer-Male-Light-256.png',NULL,0,NULL,'asd@a.com',NULL,NULL,NULL,NULL,NULL,NULL,'2014-03-09 16:21:59',NULL,1);
